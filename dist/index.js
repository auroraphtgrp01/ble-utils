...
const deviceInfoHandler_1 = require("./handler/deviceInfoHandler");
...
console.log(JSON.stringify((0, deviceInfoHandler_1.unpackDeviceInfo)(data_1.mockDeviceInfoHex), null, 2));
